 ...
 *
 */
public class XJustTrustMe extends XHook {

    private static final String TAG = "JustTrustMe";
    String currentPackageName = "";

    public static XJustTrustMe xJustTrustMe = null;
    public static XJustTrustMe getInstance() {
        if (xJustTrustMe == null) {
            xJustTrustMe = new XJustTrustMe();
        }
        return xJustTrustMe;
    }
